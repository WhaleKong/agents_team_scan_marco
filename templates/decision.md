...
> {e.g., "Fed is done hiking but market prices 3 more cuts than will happen. Short front-end rates, long USD vs JPY."}
...
|------------------|----------|------------|
| news-scanner     | {view}   | H/M/L      |
| macro-researcher | {view}   | H/M/L      |
